/obj/machinery/campfire
	...
	icon = 'icons/St_Muh_13/stalker.dmi'
...
obj/machinery/campfire/barrel
	name = "barrel"
	icon = 'icons/St_Muh_13/machinery/bochka.dmi'
	icon_state = "barrel0"
	density = 1
		...
		if(sound_playing)
			...
			if(get_dist(M, turf_source) <= 3)
				...
				if(T && T.z == turf_source.z)
					M.playsound_local(get_turf(M.loc), 'sound/St_Muh_13/objects/campfire.ogg', 80, 0, 0, 0, 0, 777, 1)
			else
