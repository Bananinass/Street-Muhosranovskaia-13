...
/obj/structure/St_Muh_13/blocks/vanish/block2/l
	icon_state = "block5l"
...
/obj/structure/St_Muh_13/blocks/vanish/pipe
	name = "Pipe"
	desc = "Громадна&#255; железобетонна&#255; труба."
	icon = 'icons/stalker/structure/decor2.dmi'
	icon_state = "truba1"

/obj/structure/St_Muh_13/blocks/vanish/pipe/pipe2
	icon_state = "truba2"
	name = "Pipe"

/obj/structure/St_Muh_13/blocks/vanish/pipe/pipe3
	icon_state = "truba3"
	name = "Pipe"

/obj/structure/St_Muh_13/blocks/vanish/shlagbaum1
	icon = 'icons/stalker/structure/decor2.dmi'
	icon_state = "shlagbaum1"

/obj/structure/St_Muh_13/blocks/vanish/shlagbaum1/shlagbaum2
	icon_state = "shlagbaum2"

/obj/structure/St_Muh_13/blocks/vanish/sandbags
	name = "sandbags"
	desc = "Обычна&#255; насыпь из мешков с песком."
	icon = 'icons/St_Muh_13/structure/sandbags.dmi'
	icon_state = "solo"

/obj/structure/St_Muh_13/blocks/vanish/shina
	name = "tire"
