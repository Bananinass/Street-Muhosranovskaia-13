...
/obj/item/weapon/storage/St_Muh_13/plita
	name = "stove"
...
/obj/item/weapon/storage/St_Muh_13/plita/attack_hand(mob/user)
	return attack_self(user)

/obj/item/weapon/storage/St_Muh_13/pech
	name = "furnace"
	desc = "Стара&#255; печь."
	icon = 'icons/St_Muh_13/structure/decor.dmi'
	icon_state = "pech"
...
/obj/structure/St_Muh_13/okno
	name = "Window"
	desc = "Старое дерев&#255;нное окно."
	icon = 'icons/St_Muh_13/structure/decor2.dmi'
	pass_flags = LETPASSTHROW
	density = 1
	opacity = 0
	var/unpassable = 0
