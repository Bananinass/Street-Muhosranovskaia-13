...
/datum/antagonist/raider
	...
	antag_indicator = "hudrebel"
	landmark_id = "voxstart"
	welcome_text = "Use :H to talk on your encrypted channel."
	flags = ANTAG_OVERRIDE_JOB | ANTAG_CLEAR_EQUIPMENT | ANTAG_CHOOSE_NAME | ANTAG_VOTABLE | ANTAG_SET_APPEARANCE | ANTAG_HAS_LEADER
	antaghud_indicator = "hudrebel"
	...
	var/list/raider_gloves = list(
		/obj/item/clothing/gloves/latex/nitrile,
		)

	var/list/raider_helmets = list(
		/obj/item/clothing/head/beret/rebel,
		)

	var/list/raider_mask = list(
		/obj/item/clothing/mask/gas/mask_dallas,
		/obj/item/clothing/mask/gas/mask_houston,
		/obj/item/clothing/mask/gas/mask_wolf,
		/obj/item/clothing/mask/gas/mask_chains,
		)
...
/datum/antagonist/raider/equip(var/mob/living/carbon/human/player)
	...
	if(player.species && player.species.get_bodytype(player) == "Vox")
		...
		var/new_mask =    pick(raider_mask)
		var/new_suit =    pick(raider_suits)
		var/new_gloves =  pick(raider_gloves)
		...
		player.equip_to_slot_or_del(new new_gloves(player),slot_gloves)
		player.equip_to_slot_or_del(new new_mask(player),slot_wear_mask)
